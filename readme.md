...
your controller should implement some delegate methods, Personally I will make `RTPageSlideViewConfigurationDelegate` first.

what `- (CGRect)pageFrame:(RTPageSlideView *)pageSlideView;` use for?
...
```
    ...
    |                                                          |
    |   ----------------------------------------------------   |
    |   | this view's frame is what the method returns     |   |
    |   |                                                  |   |
    |   |                                                  |   |
    |   |                                                  |   |
    |   |                                                  |   |
...
`RTPageSlideView` asks its `RTPageSlideViewConfigurationDelegate` for the inner page frame to assign the position.




what `- (NSInteger)pageCount:(RTPageSlideView *)pageSlideView;` use? for?

this is just like `- (NSInteger )tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section`, but we don't have sections.



what `- (CGFloat)pageGap:(RTPageSlideView *)pageSlideView;` used for?
...
### Intellectual Property
    ...
    [macvim]: http://code.google.com/p/macvim/</Plug></Plug>
